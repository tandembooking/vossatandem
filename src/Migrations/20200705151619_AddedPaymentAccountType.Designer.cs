...
namespace tandembooking.Migrations
{
    ...
    [Migration("20200705151619_AddedPaymentAccountType")]
    partial class AddedPaymentAccountType
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TandemBooking.Models.ApplicationUser", b =>
                {
                    ...
                    b.Property<bool>("IsPaymentAdmin")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("TandemBooking.Models.PaymentAccount", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TandemBooking.Models.ApplicationUser", b =>
                {
                    b.HasOne("TandemBooking.Models.PaymentAccount", "IZettlePaymentAccount")
                        .WithMany()
